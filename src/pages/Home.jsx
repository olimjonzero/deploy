...
const MOCK_PRODUCTS = [
  { 
    ...
    origin: "Turkiya",
    material: "100% Jun",
    description: "Turkiyaning eng sifatli matolaridan tayyorlangan premium klassik kostyum. Rasmiy tadbirlar va biznes uchrashuvlari uchun ideal.",
  ...
  { 
    ...
    origin: "O'zbekiston",
    material: "Shatel",
    description: "Yozgi issiq kunlari uchun yengil va havo o'tkazuvchan gulli libos.",
  ...
  { 
    ...
    img: "https://images.unsplash.com/photo-151927841797a-3634df7e452a?auto=format&fit=crop&q=80&w=500",
    minOrder: "15 dona"
  }
];
